...
import { showErrorToast } from "../utils/util.service";
import ModalBg from "./ModalBg";
import { useRequestDeliveryDateExtensionMutation } from "src/features/order/service/order.service";
...
const ExtendDateModal: FC<IExtendedDateModalProps> = ({
  ...
  const [requestDeliveryDateExtension] =
