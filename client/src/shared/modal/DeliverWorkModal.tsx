...
import { checkFile, fileType, readAsBase64 } from "../utils/image-util.service";
import {
  bytesToSize,
...
import { useDeliverOrderMutation } from "src/features/order/service/order.service";
      ...
      <div className="fixed bottom-0 left-0 right-0 top-0 z-[30] flex w-full items-center justify-center">
        {isLoading && (
          <div className="fixed bottom-0 left-0 right-0 top-0 z-[50] flex w-full items-center justify-center opacity-80">
            <div className="absolute bottom-auto left-auto right-auto top-auto flex min-h-[350px] max-h-[400px] min-w-[500px] flex-col items-center justify-center bg-white p-4 text-[#404145]">
              <FaCircleNotch
        ...
        <div className="">
          <div className="relative bottom-auto left-auto right-auto top-auto max-h-[90vh] min-w-[500px] bg-white p-4">
            <div className="mb-5 w-full text-left">
              ...
              <p>Images, Pdfs, or Zip: Max. 10Mb; Videos: Max. 100Mb</p>
            </div>
            <div>
              <TextAreaInput
                ...
                <div className="mb-5">
                  <div className="flex rounded pb-2">
                    <div className="flex h-[80px] w-[100px] flex-col items-center justify-center rounded border border-[#f1f1f1] p-3">
                      ...
                      <span className="w-[100px] truncate px-3 py-1 text-xs font-bold text-black">
                        {selectedFile?.name}
                      </span>
                      <p className="mb-0 text-xs">
                        {bytesToSize(parseInt(`${selectedFile?.size}`))}
                      </p>
                    </div>
                    <FaTimes
                      onClick={() => {
