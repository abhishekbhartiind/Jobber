...
const OfferModal: FC<IModalProps> = ({
  header,
  gigTitle,
  receiver,
  authUser,
  ...
  return (
    <ModalBg>
      <div className="fixed bottom-0 left-0 right-0 top-0 z-[150] flex w-full items-center justify-center">
        <div className="relative bottom-auto left-auto right-auto top-auto max-h-[90vh] min-w-[500px] bg-white p-4">
          ...
          <div className="relative mb-16 px-5">
            <div className="py-4">
              <label
                htmlFor="username"
                className="text-[20px] font-medium leading-tight tracking-normal"
              >
                {gigTitle}
              </label>
            </div>
            <div>
              <label
                htmlFor="description"
                className="text-sm font-bold leading-tight tracking-normal"
              >
                Description
