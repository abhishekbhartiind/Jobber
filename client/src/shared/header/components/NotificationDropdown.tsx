...
} from "src/features/order/service/notification.service";
...
const NotificationDropdown: FC<IHomeHeaderProps> = ({
  ...
  return (
    <div className="border-grey z-20 max-h-[470px] flex flex-col justify-between rounded shadow-md border border-grey bg-white">
      <div className="block px-4 py-2 font-medium text-center text-gray-700 border-b border-grey">
        Notifications
      </div>
              ...
              <div className="flex px-4">
                <div className="flex-shrink-0 mt-1">
                  <img
                    ...
                    src={
                      data.senderUsername === authUser?.username
