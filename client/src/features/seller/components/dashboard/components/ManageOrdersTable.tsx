...
import { useCancelOrderMutation } from "src/features/order/service/order.service";
            ...
            <>
              ...
              <tbody className="flex-1 sm:flex-none">
                {orders.map((order: IOrderDocument) => (
                  ...
                  >
                    <td></td>
                    <td className="flex justify-start gap-3 px-3 py-4 sm:justify-center md:justify-start">
                    ...
                    <td className="px-3 text-left lg:text-center w-[300px]">
                      <div className="grid">
                        <Link
                    ...
                    {type === "completed" && order.events.orderDelivered && (
                      <td className="p-3 text-left lg:text-center">
                        {TimeAgo.dayMonthYear(`${order.events.orderDelivered}`)}
                      </td>
                    )}
                    <td className="p-3 text-left lg:text-center">
                      ${order.price}
