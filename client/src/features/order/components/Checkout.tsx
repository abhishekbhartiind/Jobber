...
import { useCreateOrderIntentMutation } from "../service/order.service";
...
const Checkout: FC = (): ReactElement => {
  ...
  return (
    <div className="container mx-auto h-screen">
      <div className="flex flex-wrap flex-col sm:flex-row w-fit">
            ...
            <ul className="list-none mb-0">
              ...
              <li className="flex justify-between px-4 pt-2 pb-2">
                ...
                <span className="text-sm">
                  {offer.deliveryInDays} day
                  {offer.deliveryInDays > 1 ? "s" : ""}
                </span>
              </li>
              <li className="flex justify-between px-4 pt-2 pb-2">
                <div className="text-sm font-normal flex gap-2">
