...
import { useGetOrderByOrderIdQuery } from "../service/order.service";
              ...
              <div className="flex w-full flex-col flex-wrap p-4 md:w-2/3">
                <span className="text-base font-bold text-black lg:text-lg">
                  {order.delivered
                    ...
                    : "Your delivery is now in the works"}
                </span>
                {order?.delivered ? (
                  <p className="mt-1 w-5/6 flex-wrap text-sm">
                    View the delivery to make sure you have exactly what you
                    need. Let {order.sellerUsername} know your thoughts.
                  </p>
                ) : (
                  <>
                    <p className="mt-1 w-5/6 flex-wrap text-sm">
                      We notified {order.sellerUsername} about your order.
                    </p>
                    <p className="mt-1 w-5/6 flex-wrap text-sm">
