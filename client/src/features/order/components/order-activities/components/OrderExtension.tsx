...
import { useUpdateDeliveryDateMutation } from "src/features/order/service/order.service";
                    ...
                    <div className="items-left mt-2 flex flex-col gap-2 text-gray-500 md:flex-row md:items-center">
                      {order?.buyerUsername === authUser?.username ? (
                        <span className="text-sm font-bold md:text-base">
                          {order.sellerUsername} requested for a delivery date
                          extension
                        </span>
                      ) : (
                        <span className="text-sm font-bold md:text-base">
                          You requested for a delivery date extension
                        </span>
                      )}
                    </div>
                  </div>
              ...
              <div className="border-grey w-full border-b pb-6">
                <div className="flex items-center justify-between font-medium text-gray-500">
                  <div className="items-left mt-2 flex flex-col gap-2 text-gray-500 md:flex-row md:items-center">
                    {order?.buyerUsername !== authUser?.username ? (
                      <span className="text-sm font-bold md:text-base">
                        {order.buyerUsername} approved delivery date extension
                        request
                      </span>
                    ) : (
                      <span className="text-sm font-bold md:text-base">
                        You approved delivery date extension request
                      </span>
                    )}
