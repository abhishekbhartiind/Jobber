...
import { useApproveOrderMutation } from "src/features/order/service/order.service";
...
const ChatBox: LazyExoticComponent<FC<IChatBoxProps>> = lazy(
  () => import("src/features/chat/components/chatBox/ChatBox")
);
                  ...
                  <div className="mt-2 flex items-center justify-between font-medium text-gray-500">
                    ...
                    <div
                      onClick={() =>
                        setOrderDeliveredModal({
                          ...orderDeliveredModal,
                          delivery: !orderDeliveredModal.delivery
                        })
                      }
                    >
                                ...
                                <div className="flex justify-between text-sm font-bold text-[#777d74] md:text-base">
                                  <span>
                                    {authUser?.username === order.buyerUsername
                                      ? `${order.sellerUsername}'s message`
                                      : "Me"}
                                  </span>
                                </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="border-grey w-full border-b pb-6">
                  <div className="mt-2 flex items-center gap-2 font-medium text-gray-500">
                    ...
                    {!order.approved &&
                      authUser?.username === order.buyerUsername && (
                        <span>Are you ready to approve the delivery?</span>
                      )}
                    {!order.approved &&
                      authUser?.username !== order.buyerUsername && (
                              ...
                              <div className="w-full text-sm dark:text-white">
                                <div className="flex flex-col justify-between text-[#777d74]">
                                  <span className="text-sm md:text-[15px]">
                                    ...
                                    seller before approving, you can go to
                                    <a
                                      onClick={() =>
